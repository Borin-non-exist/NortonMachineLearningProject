...
const WelcomePage: React.FC = () => {
  ...
  return (
    <div className="relative h-screen bg-blue-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 flex justify-between items-center px-4 sm:px-8 py-4 bg-blue-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 z-20">
