      ...
      <aside className="w-64 fixed top-0 left-0 h-screen bg-white dark:bg-gray-800 shadow z-50 flex flex-col justify-between p-4 overflow-y-auto">
        ...
        <div>
          ...
          <nav className="space-y-2">
            <Link to="/doctor" className={linkClasses("/doctor")}>
              <FaTachometerAlt className="text-lg" />
              <span>Dashboard</span>
            </Link>

            <Link to="/disease-knowledge" className={linkClasses("/disease-knowledge")}>
              <FaBookMedical className="text-lg" />
              <span>Disease Knowledge</span>
            </Link>

            <Link to="/SettingDoctor" className={linkClasses("/SettingDoctor")}>
