// resources/js/Pages/Admin/EditSymptomPage.tsx
...
export default function EditSymptomPage({ symptoms = [] }: EditSymptomProps) {
    ...
    const { props } = usePage() as { props: { success?: string; errors?: Record<string, string> } };
    ...
    const filtered = useMemo(
        () =>
            symptoms.filter((s) => s.name.toLowerCase().includes(search.toLowerCase())),
        [symptoms, search]
    );
