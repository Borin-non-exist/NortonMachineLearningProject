    ...
    <div className="min-h-screen bg-blue-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 p-6 sm:p-10 transition-colors">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="space-y-8">
          {[
            ...
            },
            {
              ...
              desc: "PiKrus will give you a likely diagnosis and basic advice. Consult a real doctor for confirmation.",
            },
            {
        ...
        <div className="text-center pt-10">
          <button
            onClick={() => window.history.back()} // This tells the browser to go back one step in history
