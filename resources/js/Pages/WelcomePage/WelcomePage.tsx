...
//   // close sidebar on outside click (type-safe)
//   useEffect(() => {
...
//       // Prefer composedPath when available (Shadow DOM–safe)
//       const path = typeof ev.composedPath === "function" ? ev.composedPath() : undefined;
//       if (Array.isArray(path) && path.includes(sidebarEl)) return; // inside

//       const target = e.target as Node | null;
//       if (target && sidebarEl.contains(target)) return; // inside (fallback)
...
//   // refresh only recentLogs via Inertia partial reload
//   const refreshLogs = () => {
...
//   return (
//     <div className="relative min-h-screen bg-blue-50 text-gray-800">
//       {/* Header */}
//       <header
//         ref={headerRef}
//         className="fixed top-0 left-0 right-0 flex justify-between items-center px-4 sm:px-8 py-4 bg-blue-50 z-30 border-b border-gray-200"
//       >
...
//             >
//               {sidebarOpen ? (
//                 <CloseIcon className="h-5 w-5 sm:h-6 sm:w-6 text-gray-600" />
//               ) : (
...
//               <div
//                 className="border-2 border-blue-300 rounded-lg p-6 bg-white hover:shadow-lg transition-colors cursor-pointer"
//                 onClick={() => router.get("/symptom-form")}
//               >
//                 <h2 className="text-xl sm:text-2xl font-semibold text-blue-600 mb-2">
//                   Health Diagnosis
//                 </h2>
//                 <p className="text-gray-600 mb-4">Symptom Checker</p>
...
//                   Health Roadmap
//                 </h2>
//                 <p className="text-gray-600 mb-4">Disease Explorer</p>
//                 <p className="text-sm text-gray-500">
...
//               <div
//                 className="border-2 border-blue-300 rounded-lg p-6 bg-white hover:shadow-lg transition-colors cursor-pointer"
//                 onClick={() => router.get("/settingadmin")}
//               >
//                 <h2 className="text-xl sm:text-2xl font-semibold text-blue-600 mb-2">
//                   Your Health History
//                 </h2>
...
//               <button
//                 onClick={() => router.get("/")}
//                 className="w-28 h-12 flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl shadow-lg transition duration-200 text-lg font-medium"
...
//         <aside
//           ref={sidebarRef}
//           className={`fixed right-0 w-full md:w-1/4 bg-white p-4 sm:p-6 overflow-y-auto border-l border-gray-200 z-20 transform transition-transform duration-300 ${
//             sidebarOpen ? "translate-x-0" : "translate-x-full"
//           }`}
//           style={{ top: headerH, height: `calc(100vh - ${headerH}px)` }}
//         >
//           <div className="flex items-center justify-between mb-4">
//             <h3 className="text-lg sm:text-xl font-semibold text-gray-800">Recently</h3>
...
//                 isRefreshing ? "opacity-70 cursor-not-allowed" : "hover:bg-gray-50"
//               }`}
...
//               {isRefreshing &&
//                 [0, 1, 2].map((i) => (
//                   <li key={`sk-${i}`} className="p-3 border border-gray-200 rounded-lg bg-white animate-pulse">
...
//                   <li
//                     key={id}
//                     className="p-3 bg-white border border-gray-200 rounded-lg hover:shadow-sm transition cursor-pointer"
//                     onClick={() => {
...
//                       <span>Step {step}</span>
//                       {isFinal && <span className="px-2 py-0.5 rounded-full bg-green-100 text-green-700">Final</span>}
