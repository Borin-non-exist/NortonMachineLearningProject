...
const SettingDoctorPage: React.FC = () => {
      ...
      <aside className="hidden md:flex flex-col w-64 h-screen fixed top-0 left-0 bg-white dark:bg-gray-800 p-6 border-r border-gray-200 dark:border-gray-700 z-40">
        ...
        <nav className="space-y-4 flex-1">
          <button
            ...
            className={`w-full text-left font-medium px-3 py-2 rounded-lg ${view === "account"
          ...
          <button
            ...
            className={`w-full text-left font-medium px-3 py-2 rounded-lg ${view === "security"
                ? "bg-blue-100 dark:bg-blue-700 text-blue-600 dark:text-white"
                : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
              }`}
          >
...
export default SettingDoctorPage;