        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="border-2 border-blue-400 dark:border-blue-700 rounded-xl p-4 sm:p-6 bg-white dark:bg-gray-900 shadow-md space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <StatCard icon={<FaUserInjured />} label="Total Patients" value={stats.totalPatients} /* percentage={stats.patientPercentage + "%"} */ />
              <StatCard icon={<FaKey />} label="Total Knowledgebases" value={stats.totalDiseases} /* percentage={stats.diseasePercentage + "%"} */ />
              <StatCard icon={<FaUserMd />} label="Total Doctors" value={stats.totalDoctors} /* percentage={stats.doctorPercentage + "%"} */ />
            </div>
            {/* Charts */}
